...
.. code-block:: php
    ...
    // В макете src/Template/Layout/default.php
...
**src/Template/Layout/default.php**. Если вы хотите полностью изменить внешний
...
**src/Template/Element/helpbox.php** может использовать переменную
``$helptext``::

    // Внутри файла src/Template/Element/helpbox.php
