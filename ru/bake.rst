...
Консоль Bake можеш создать любой из базовых компонентов или все сразу: models,
...
Кстати, Bake это естественный шаг для статической генерации кода.

Установка
============

Перед тем, как использовать Bake, убедитесь, что онустановлен в вашем приложении. 
Bake предоставлен как отдельный плагин и вы можете установить его с помощью Composer`a:
