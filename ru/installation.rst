...
CakePHP довольно прост и легок в установке. Минимальные требования веб-сервер и копия CakePHP, это все что Вам нужно! Поскольку этот раздел сосредоточен на установке CakePHP на Apache (потому что он прост в установке и настройке), CakePHP может также работать и с другими веб-серверами, как Nginx, LightHTTP или Microsoft IIS.
...
Прежде чем вы начнете установку убедитесь что у Вас установлена необходимая минимальная версия PHP:
...
версия интерфейса коммандной строки PHP (CLI) 5.5.9 или выше.
