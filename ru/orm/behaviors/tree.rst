...
Более подробную информацию о значении полей и способах их использования можно найти
в этой статье - `MPTT logic <http://www.sitepoint.com/hierarchical-data-database-2/>`_
