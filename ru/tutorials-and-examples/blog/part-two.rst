...
.. code-block:: php
    ...
    <!-- Файл: templates/Articles/index.php -->
...
файл **templates/Articles/view.php**
...
**templates/Articles/index.php**, добавив ссылку "Добавить статью".
...
.. code-block:: php
    ...
    <!-- Файл: templates/Articles/index.php  (добавлены ссылки редактирования) -->
...
.. code-block:: php
    ...
    <!-- Файл: templates/Articles/index.php (Добавлены ссылки для удаления) -->
