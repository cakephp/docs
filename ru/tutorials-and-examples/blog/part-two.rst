...
.. code-block:: php
    ...
    <!-- Файл: src/Template/Articles/index.php -->
...
файл **src/Template/Articles/view.php**
...
**src/Template/Articles/index.php**, добавив ссылку "Добавить статью".
...
.. code-block:: php
    ...
    <!-- Файл: src/Template/Articles/index.php  (добавлены ссылки редактирования) -->
...
.. code-block:: php
    ...
    <!-- Файл: src/Template/Articles/index.php (Добавлены ссылки для удаления) -->
...
Создавая приложения таким способом, вы сэкономите огромное количество
времени и ресурсов для воплощения даже самых безумных ваших идей.
