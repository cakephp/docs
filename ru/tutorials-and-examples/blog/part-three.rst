...
Вам придется внести следующие правки в **templates/Categories/add.php**
и в **templates/Categories/edit.php**::
...
В **templates/Categories/index.php** замените содержимое на::
...
.. code-block:: php
    ...
    <!-- Файл: templates/Articles/add.php -->
