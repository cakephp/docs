...
Вам придется внести следующие правки в **src/Template/Categories/add.php**
и в **src/Template/Categories/edit.php**::
...
В **src/Template/Categories/index.php** замените содержимое на::
...
.. code-block:: php
    ...
    <!-- Файл: src/Template/Articles/add.php -->
