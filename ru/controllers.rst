...
Файлы шаблонов для этих экшенов, назывались бы **src/Template/Recipes/view.php**,
**src/Template/Recipes/share.php**, и **src/Template/Recipes/search.php**. По
...
обработан файл вида **src/Template/Recipes/search.php**::
    ...
    // ...
        ...
        {
            // Обработка вида из src/Template/Recipes/search.php
            $this->render();
        }
    // ...
    }
...
обращение к  элементам, к примеру в вызовах AJAX::
    ...
    // Обработка элемента из src/Template/Element/ajaxreturn.php
...
Это отобразило бы **src/Template/Posts/custom_file.php** вместо
...
Это отобразило бы  **plugins/Users/src/Template/UserDetails/custom_file.php**
