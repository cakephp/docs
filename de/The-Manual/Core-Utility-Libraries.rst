Kern Zusatz Bibliotheken
########################

CakePHP liefert eine Reihe von generischen Bibliotheken mit, die überall
in der Anwendung benutzt werden können um verschiedene Aufgaben zu
erledigen. So zum Beispiel Set und HttpSocket.
