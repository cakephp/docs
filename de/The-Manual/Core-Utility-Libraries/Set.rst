...
Set::matches kann benutzt werden um zu sehen, ob ein einzelner Wert oder
ein gegebener xpath eine bestimmte Bedingung erfüllt.
...
Diese Funktion fusioniert zwei Arrays und fügt die Differnzen aus array2
an des Ende des resultierenden Arrays an.
...
Filtert leere Elemente ausschließlich '0' aus einem route-Array heraus.
...
Diese Funktion kann als Mischung aus array\_merge und
array\_merge\_recursive aus PHP betrachtet werden. Der Unterschied zu
diesen beiden Funktionen liegt darin, dass sich die Funktion rekursiv
verhält, wenn ein Array-Schlüssel ein weiteres Array enthält (nicht wie
array\_merge). Für Schlüssel, die Strings enthalten ist das nicht der
Fall (nicht wie array\_merge\_recursive). Für weitere Informationen
siehe Unit-Test.

Diese Funktion arbeitet mit einer unlimitierten Anzahl an Argumenten und
typecastet Parameter, die kein Array sind, zu Arrays.
...
Bestimmt, ob ein Set oder Array genau die gleichen Schlüssel und Werte
des anderen enthält.
