...
Allgemeines über Caching
========================

Caching ist als Methode zur temporären Speicherung gedacht, um die
Serverlast zu reduzieren. Zum Beispiel können die Ergebnisse eine
zeitintensiven Datenbankabfrage gespeichert werden, damit die Abfrage
nicht bei jedem Aufruf der Seite ausgeführt werden muss.

Wenn man dies im Hinterkopf hat wird klar, dass Caching kein permanenter
Speicher ist und nicht dazu benutzt wird, um irgendetwas permanent zu
speichern. Sondern nur zum Cachen von Daten dient, die wieder abgerufen
...
Cache <http://php.net/apc>`_ opcode Cacher. Like XCache, this engine
