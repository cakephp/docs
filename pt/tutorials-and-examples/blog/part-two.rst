Tutorial de Blog - Parte 2
##########################

Criar um model Article
======================

Models (modelos) são o pão com manteiga das aplicações do CakePHP. Ao
criar um model no CakePHP que irá interagir com nosso banco de dados,
nós teremos a fundação preparada para construir nossas operações
view, add, edit e delete mais tarde.
