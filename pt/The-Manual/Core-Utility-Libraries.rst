Biblioteca de Utilitários Principais
####################################

O CakePHP inclui bibliotecas de utilitários de propósito geral que podem
ser chamadas a partir de qualquer lugar em sua aplicação, tais como Set
e HttpSocket.
