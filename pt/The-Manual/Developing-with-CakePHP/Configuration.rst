...
Resista a essa vontade. Você ficará agradecido ao fazer as tais coisas
no lugar certo.

Você deve considerar colocar algumas coisas na classe AppController.
Esta é a classe Pai de todos os outros *controllers* da sua aplicação.
AppController é um lugar conveniente para utilizar os *controller
callbacks* e define métodos para serem usados por todos os seus
*controllers*.
