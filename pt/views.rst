...
O :php:class:`Cake\\View\\Helper\\HtmlHelper` também lhe permite controlar qual *block* o css ou script irá::
...
Se você quer usar um layout existente em um plugin, você pode usar :term:`sintaxe de plugin`.
...
a familiar :term:`sintaxe de plugin`. Se a *view* está sendo renderizada de um
