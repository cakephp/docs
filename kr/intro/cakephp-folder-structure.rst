...
CakePHP 어플리케이션을 다운로드하면 다음과 같이 몇 가지 상위 레벨 폴더가 있습니다.
...
- *vendor* 폴더는 CakePHP와 타 어플리케이션의 의존 라이브러리가 `Composer
  ...
  이 파일들을 수정하는 것은 권장하지 않습니다. 다음 업데이트시 Composer 가 변경한 내용을 덮어쓰기 때문입니다.
...
어플리케이션 개발의 대부분은 CakePHP의 *src* 폴더에서 합니다.
그럼 *src* 폴더 안을 조금씩 살펴보겠습니다.
