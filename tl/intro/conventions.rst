...
will look for a view template in **src/Template/Articles/view_all.php**.

The basic pattern is
**src/Template/Controller/underscored_function_name.php**.
...
-  View template, found at **src/Template/Articles/index.php**
