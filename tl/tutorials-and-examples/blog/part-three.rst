...
You'll need to edit the following in **src/Template/Categories/add.php**
and **src/Template/Categories/edit.php**::
...
In **src/Template/Categories/index.php** replace the existing content with::
