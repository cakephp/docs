...
The template files for these actions would be **src/Template/Recipes/view.php**,
**src/Template/Recipes/share.php**, and **src/Template/Recipes/search.php**. The
...
the view file in **src/Template/Recipes/search.php** will be rendered::
...
direct rendering of elements, very useful in AJAX calls::
    ...
    // Render the element in src/Template/Element/ajaxreturn.php
...
This would render **src/Template/Posts/custom_file.php** instead of
...
This would render **plugins/Users/src/Template/UserDetails/custom_file.php**
