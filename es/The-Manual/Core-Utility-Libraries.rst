Librerias de utilidades del núcleo
##################################

CakePHP incluye librerías de utilidades de propósito general que se
pueden invocar desde cualquier lugar de la aplicación. Por ejemplo, Set
y HttpSocket.
