...
de la clase ``ArticlesController`` mostrará la vista **src/Template/Articles/view_all.php**.

El patrón base es **src/Template/Controller/nombre_funcion.php**.
...
-  Plantilla vista, ubicada en **src/Template/Articles/index.php**
