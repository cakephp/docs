...
Controlerele reprezinta litera 'C' din MVC. Dupa ce rutarea a fost aplicata si 
s-a gasit controllerul corect, actiunea controlerului dvs este apelata. 
Controlerul dvs se va ocupa de interpretarea datelor solicitate, asigurand ca 
sunt apelate modelele corecte, and the right response or view is rendered. Controllers can be
