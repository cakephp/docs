...
View-urile reprezinta **V**-ul din MVC. View-urile sunt responsabile de generarea
de rezultate specifice solicitate de request. Adesea acestea sunt sub forma
de HTML, XML sau JSON, dar procesarea fisierelor si crearea de PDF-uri
pe care userii le pot downloada sunt, de asemenea, responsabilitatile layer-ului View.

CakePHP vine ca cateva clase View pre-definite pentru a acoperi cele
mai uzuale scenarii de redare:

- pentru a crea servicii web XML sau JSON puteti folosi :doc:`views/json-and-xml-views`.
- pentru a servi fisiere protejate, sau fsiere generate dinamic, puteti folosi
