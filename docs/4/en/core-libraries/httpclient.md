...
[scoped clients](../core-libraries/tmp.EGNPHQmvI7#http_client_scoped_client).
...
See [Http Client Request Options](../core-libraries/tmp.EGNPHQmvI7#http_client_request_options) for more information on the options
supported.
