...
Optionally you can `get()` an entity using [Custom Find Methods](../orm/tmp.RKf2T4n7JP#custom-find-methods). For
...
your queries up as [Custom Find Methods](../orm/tmp.RKf2T4n7JP#custom-find-methods) instead. Using custom finder
...
a [Map Reduce](../orm/tmp.RKf2T4n7JP#map-reduce) function to modify the results. The map reduce features
...
not supported with dynamic finders. You should use [Custom Find Methods](../orm/tmp.RKf2T4n7JP#custom-find-methods) to
...
[Eager Loading Associations](../orm/tmp.RKf2T4n7JP#eager-loading-associations).
...
[Filtering By Associated Data](../orm/tmp.RKf2T4n7JP#filtering-by-associated-data).
...
[matching()](../orm/tmp.RKf2T4n7JP#filtering-by-associated-data). If you have defined custom
...
[Lazy Load Associations](../orm/entities#lazy-load-associations) and [Loading Additional Associations](../orm/tmp.RKf2T4n7JP#loading-additional-associations)
...
[Custom Find Methods](../orm/tmp.RKf2T4n7JP#custom-find-methods) section:
