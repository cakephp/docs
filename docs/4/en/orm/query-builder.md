...
See the [Advanced Query Conditions](../orm/tmp.BcKF66wb2j#advanced-query-conditions) section to find out how to construct
...
> [Using Sql Functions](../orm/tmp.BcKF66wb2j#using-sql-functions) section for how to safely include unsafe data
> into function calls.
