...
- With the addition of [Dispatcher Filters](../development/dispatch-filters) you'll need to
  ...
  [Required Steps To Upgrade 2 2](../appendices/2-7-migration-guide#required-steps-to-upgrade-2-2).
...
your `app/Config/bootstrap.php`. See [Required Steps To Upgrade 2 2](../appendices/2-7-migration-guide#required-steps-to-upgrade-2-2),
