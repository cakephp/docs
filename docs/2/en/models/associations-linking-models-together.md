...
- **counterCache**: If set to true, the associated Model will
  ...
  by defining an array. See [Multiple Countercache](../models/tmp.upkMIibeTj#multiple-counterCache).
...
> HABTM, see [Hasmany Through](../models/tmp.upkMIibeTj#hasMany-through).
...
key in [HABTM association arrays](../models/tmp.upkMIibeTj#ref-habtm-arrays).
