...
See [Disabling Default Routes](../development/tmp.XDTNoBUDY8#disabling-default-routes) on how to disable the default routing.
...
string, but can also contain a wildcard (\*) or [Route Elements](../development/tmp.XDTNoBUDY8#route-elements).
...
> content from 2 different URLs. See [Disabling Default Routes](../development/tmp.XDTNoBUDY8#disabling-default-routes) to
...
[Route Elements](../development/tmp.XDTNoBUDY8#route-elements), you can create variable routes, that accept
...
arguments will be made available in the [Passed Arguments](../development/tmp.XDTNoBUDY8#passed-arguments)
array.
...
- `prefix` Used for [Prefix Routing](../development/tmp.XDTNoBUDY8#prefix-routing)
- `ext` Used for [File Extensions](../development/tmp.XDTNoBUDY8#file-extensions) routing.

### Passing Parameters to Action

When connecting routes using [Route Elements](../development/tmp.XDTNoBUDY8#route-elements) you may want
...
conditions, but you can add more using [Custom Route Classes](../development/tmp.XDTNoBUDY8#custom-route-classes). The built-in
options are:
