...
2.5 より前は、グローバルマネージャーのリスナーは、分割されたリストに保持され、インスタンスリスナーより  実行されていました。 2.5 以降は、グローバルインスタンスもインスタンスリスナーも優先順位に従って実行されます。
:::
...
`CakeEvent` は、そのコンストラクタに3つの引数を受け取ります。最初のものはイベント名で、
