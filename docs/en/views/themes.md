...
See the section on [Plugin Create Your Own](../plugins#creating-your-own-plugins).
...
performance for production environments, it's recommended that you [Symlink Assets](../deployment#moving-files).
