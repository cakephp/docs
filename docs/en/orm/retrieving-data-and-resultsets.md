...
Optionally you can `get()` an entity using [Custom Find Methods](#custom-finder-methods). For
...
your queries up as [Custom Find Methods](#custom-finder-methods) instead. Using custom finder
...
See [Query Count](../orm/query-builder#returning-the-total-count-of-records) for additional usage of the `count()` method.
...
a [Map Reduce](#modifying-results-with-mapreduce) function to modify the results. The map reduce features
...
not supported with dynamic finders. You should use [Custom Find Methods](#custom-finder-methods) to
...
[Eager Loading Associations](#eager-loading-associations-via-contain).
...
[Filtering By Associated Data](#filtering-by-associated-data-via-matching-and-joins).
...
[matching()](#filtering-by-associated-data-via-matching-and-joins). If you have defined custom
...
[Lazy Load Associations](../orm/entities#lazy-loading-associations) and [Loading Additional Associations](#loading-additional-associations)
...
done with result sets using the collections features. The [Format Results](../orm/query-builder#adding-calculated-fields)
...
[Custom Find Methods](#custom-finder-methods) section:
