...
your Table's [\_initializeSchema() method](../orm/saving-data#saving-complex-types):
...
[Schema Cache Shell](../console-and-shells/schema-cache) chapter for more information.
