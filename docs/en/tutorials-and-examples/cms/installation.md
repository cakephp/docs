...
You should have at least PHP |minphpversion| (CLI) or higher installed. Your webserver's PHP version must also be of |minphpversion| or higher, and should be the same version your command line interface (CLI) PHP is.
