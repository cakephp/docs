...
To access other parts of the request data, consult the [Cake Request](../../controllers/request-response#request)
section.
...
We just implemented a [custom finder method](../../orm/retrieving-data-and-resultsets#custom-finder-methods). This is
