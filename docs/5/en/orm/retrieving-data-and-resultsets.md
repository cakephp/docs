...
Optionally you can `get()` an entity using [Custom Find Methods](../orm/retrieving-data-and-resultsets#custom-find-methods). For
...
your queries up as [Custom Find Methods](../orm/retrieving-data-and-resultsets#custom-find-methods) instead. Using custom finder
...
a [Map Reduce](../orm/retrieving-data-and-resultsets#map-reduce) function to modify the results. The map reduce features
...
not supported with dynamic finders. You should use [Custom Find Methods](../orm/retrieving-data-and-resultsets#custom-find-methods) to
...
[Eager Loading Associations](../orm/retrieving-data-and-resultsets#eager-loading-associations).
...
[Filtering By Associated Data](../orm/retrieving-data-and-resultsets#filtering-by-associated-data).
...
[Lazy Load Associations](../orm/entities#lazy-load-associations) and [Loading Additional Associations](../orm/retrieving-data-and-resultsets#loading-additional-associations)
...
[Custom Find Methods](../orm/retrieving-data-and-resultsets#custom-find-methods) section:
