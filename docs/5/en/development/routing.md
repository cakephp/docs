...
a wildcard (\*) or [Route Elements](../development/tmp.MUgrXd7NfB#route-elements). Using a wildcard tells the router
...
the `{action}` parameter. By using [Route Elements](../development/tmp.MUgrXd7NfB#route-elements), you can create
...
the [Passed Arguments](../development/tmp.MUgrXd7NfB#passed-arguments) array.
...
[fluent setters](../development/tmp.MUgrXd7NfB#route-fluent-methods) to further configure your route.
...
- `prefix` Used for [Prefix Routing](../development/tmp.MUgrXd7NfB#prefix-routing)
- `_ext` Used for [File extentions routing](../development/tmp.MUgrXd7NfB#file-extensions).
...
- `_method` Define the HTTP verb/method to use. Useful when working with
  [Resource Routes](../development/tmp.MUgrXd7NfB#resource-routes).
...
When connecting routes using [Route Elements](../development/tmp.MUgrXd7NfB#route-elements) you may want to have routed
...
compatible with [Prefix Routing](../development/tmp.MUgrXd7NfB#prefix-routing).
...
Elements with numeric keys are treated as [Passed Arguments](../development/tmp.MUgrXd7NfB#passed-arguments).
...
- `_ext` Used for [File Extensions](../development/tmp.MUgrXd7NfB#file-extensions) routing.
- `_base` Set to `false` to remove the base path from the generated URL. If
  your application is not in the root directory, this can be used to generate
  URLs that are 'cake relative'.
