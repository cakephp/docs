...
> [Hash Path Syntax](../core-libraries/tmp.56ulZU8znK#hash-path-syntax). You can use extract to retrieve data from arrays
...
> ```
>
> Sorts an array by any value, determined by a [Hash Path Syntax](../core-libraries/tmp.56ulZU8znK#hash-path-syntax)
