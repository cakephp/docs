...
[scoped clients](../core-libraries/tmp.Qwd9cyyjGG#http_client_scoped_client).
...
See [Http Client Request Options](../core-libraries/tmp.Qwd9cyyjGG#http_client_request_options) for more information on the options
supported.
