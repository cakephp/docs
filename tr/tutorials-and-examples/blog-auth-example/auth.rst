...
.. meta::
    :title lang=tr: Simple Authentication and Authorization Application
    :keywords lang=tr: auto increment,authorization application,model user,array,conventions,authentication,urls,cakephp,delete,doc,columns
