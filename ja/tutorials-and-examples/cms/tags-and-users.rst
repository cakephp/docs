...
**src/Template/Articles/add.php** のコントロールの PHP ブロックに以下を追加してください。 ::
...
**src/Template/Articles/edit.php** テンプレートに追加することを忘れないでください。
...
**src/Template/Articles/tags.php** の中に次の内容を入れてください。 ::
...
**src/Template/Articles/add.php** と **src/Template/Articles/edit.php** の中で、
