...
新しい 'view' アクションのビューを作成し、 **src/Template/Articles/view.php**
に置きましょう。
...
さて、 **src/Template/Articles/index.php** ビューを更新して、新しい
...
.. code-block:: php
    ...
    <!-- File: src/Template/Articles/index.php  (編集リンク付き) -->
...
.. code-block:: php
    ...
    <!-- File: src/Template/Articles/index.php  (削除リンク付き) -->
