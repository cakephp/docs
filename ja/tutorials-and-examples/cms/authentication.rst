...
You can edit the default user that was created during :doc:`Installation <installation>`.
...
Now that users can log in, we'll want to limit users to only edit articles that they created by :doc:`applying authorization policies <./authorization>`.
