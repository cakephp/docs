...
`PHPUnit <https://phpunit.de>`_ と統合されています。PHPUnit が提供する機能に加えて、
...
`Xdebug <https://xdebug.org>`_ をインストールしてあればコードカバレッジの結果を見ることができます。
...
`Jenkins <https://jenkins-ci.org>`_ は継続的インテグレーションサービスで、テストケースの自動化を
...
`Jenkins documentation <https://jenkins-ci.org/>`_ または
