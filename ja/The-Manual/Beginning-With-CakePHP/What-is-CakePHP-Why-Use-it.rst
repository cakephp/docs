...
CakePHPにはアクティブな\ `開発チーム <https://trac.cakephp.org/wiki/Contributors>`_\ と\ `コミュニティ <http://cakephp.org/feeds>`_\ が存在し、プロジェクトに貢献しています。CakePHPを使用する、ということは、車輪の再開発を避けるだけでなく、あなたが開発するアプリケーションのコア部分がよくテストされ、常に改良されている、ということになります。
