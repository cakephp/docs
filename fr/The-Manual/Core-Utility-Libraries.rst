Librairies utilitaires intégrées
################################

CakePHP inclut des librairies utilitaires universelles, lesquelles
peuvent être appelées depuis tout point de votre application, telles que
: *Set* et *HttpSocket*.
