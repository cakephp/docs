...
ajouter le nom de l'assistant au tableau $helpers dans
*/app/app\_controller.php* (à créer si pas encore présent). Souvenez
vous d'inclure les assistants par défaut Html et Form.
