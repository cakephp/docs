...
+---------------+--------------------------+----------------------------------------------------+
| Image         | ImageCommentaire         | images\_commentaires\_count                        |
+---------------+--------------------------+----------------------------------------------------+
...
(HABTM) </fr/view/85/Saving-Related-Model-Data-HABTM>`_
...
utilise une table livres\_tags table comme table de jointure, donc vous
avez besoin de joindre la table livres à la table livres\_tags et
