...
comme des champsVirtuels qui ne se mettent pas à jour pour refléter l'alias
lié. Si vous utilisez les champsVirtuels dans les models qui ont plus d'un
alias, il est mieux de définir les champsVirtuels dans le constructeur de votre
model::
...
Si cela arrive, ``0`` serait retourné dans la colonne TotalHours::
...
Lancer la requête de nouveau après avoir specifié le champ virtuel résulterait
