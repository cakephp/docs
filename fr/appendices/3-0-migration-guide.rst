...
* Les Logs de configuration sont maintenant immutable. Si vous devez changer
...
- Le prefix ``data[`` a été retirée de tous les inputs générés. Le prefix
  ne sert réellement plus à rien.
