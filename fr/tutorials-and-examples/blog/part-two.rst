...
dans **src/Template/Articles/view.php**.
...
**src/Template/Articles/index.php** pour ajouter un lien "Ajouter un article".
...
.. code-block:: php
    ...
    <!-- File: src/Template/Articles/index.php  (liens de modification ajoutés) -->
