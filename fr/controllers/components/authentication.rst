...
- Retourne l'URL normalisée de valeur Auth.La valeur redirect si elle est
...
ressources de la requête. Le callback est passé à l'utilisateur actif, aussi
...
authError
    ...
    Vous pouvez supprimer les message authError message de l'affichage par défaut
