...
AppController (disponible dans ``src/Controller/AppController.php``),
AppHelper (disponible dans ``src/View/Helper/AppHelper.php``) et
AppModel (disponible dans ``src/Model/AppModel.php``) sont de bons choix
