...
`Plugin Models </view/1114/Plugin-Models>`_.
...
assumed, it `has to be changed in model </view/1061/primaryKey>`_
...
`Saving Related Model Data (HABTM) </view/1034/Saving-Related-Model-Data-HABTM>`_

For more information on binding model associations on the fly see
`Creating and destroying associations on the fly </view/1045/Creating-and-Destroying-Associations-on-the-Fly>`_
