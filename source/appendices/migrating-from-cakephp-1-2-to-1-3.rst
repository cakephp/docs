...
-  ``Object::$_log`` has been removed. ``CakeLog::write`` is now
   called statically. See `New Logging features </view/1194/Logging>`_
...
`New features guide </view/1572/New-features-in-CakePHP-1-3>`_ for
...
`Form helper improvements </view/1616/x1-3-improvements>`_ for
