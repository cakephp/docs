...
:doc:`/tutorials-and-examples/blog/part-two`, or follow the
...
Once you are done with the tutorials, these are common tasks people learning
CakePHP often want to study next:

1. :ref:`view-layouts`: Customizing the application layout
