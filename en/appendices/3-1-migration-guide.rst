...
The default route class has been changed to `DashedRoute` in the ``cakephp/app``
repo. Your current code base is not affected by this, but it is recommended to
use this route class from now on.
