...
Finally you can use ``closures`` to generate paths dinamically, for example when working with entities and dates (converted to ``Cake/Time instances`` by the ORM) you may want to group results by date::
