...
will be passed to password hasher contructor as config. The default hasher
...
In CakePHP 2.3 the ``BlowfishAuthenticate`` class was introducted to allow
...
A blowfish password hasher can be used with any authenticate class. All you have
