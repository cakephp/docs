...
You can this behavior by specifying ``valuesSources`` either as an option or by calling it as a setter. The default is
``['context']``.
...
Setting custom value sources you can easily create `HTTP GET` based forms, such as filter forms. Example:
