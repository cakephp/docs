...
`open-source <http://en.wikipedia.org/wiki/Open_source>`_, `rapid
development <http://en.wikipedia.org/wiki/Rapid_application_development>`_
`framework <http://en.wikipedia.org/wiki/Application_framework>`_ for
...
team <https://trac.cakephp.org/wiki/Contributors>`_ and community,
...
-  Fast and flexible
   `templating <http://en.wikipedia.org/wiki/Web_template_system>`_ (PHP
   syntax, with helpers)
-  View Helpers for AJAX, JavaScript, HTML Forms and more
-  Email, Cookie, Security, Session, and Request Handling Components
-  Flexible `ACL <http://en.wikipedia.org/wiki/Access_control_list>`_
-  Data Sanitization
