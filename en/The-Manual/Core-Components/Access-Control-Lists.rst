...
Now that you've got your permissions defined, you can skip along to :doc:`/The-Manual/Core-Components/Access-Control-Lists` using the ACL
component.
...
You can also use the SQL file found in ``app/config/sql/db_acl.sql``,
...
uses CakePHP's :doc:`/The-Manual/Core-Behaviors/Tree` to manage the
