...
The default method for form submission is POST. The form element also is
...
specifying a type. In addition to the field types found in the :doc:`/The-Manual/Core-Helpers/Form`, you can also create ‘file’,
and ‘password’ inputs.
...
uploads <https://php.net/features.file-upload>`_.
