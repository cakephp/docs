...
of your visitors and inform your application about the content types and
...
more about `creating your own components </view/62/components>`_.

All core components now can be configured in the ``$components`` array
of a controller.
