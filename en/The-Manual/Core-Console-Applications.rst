...
Before you dive in here, you may want to check out the :doc:`/The-Manual/Developing-with-CakePHP/The-CakePHP-Console` covered earlier. Console
setup isn't covered here, so if you've never used the console before,
check it out.
