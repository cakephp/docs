...
Creating a project using :doc:`/The-Manual/Core-Console-Applications/Code-Generation-with-Bake`
...
See also :doc:`/The-Manual/Developing-with-CakePHP/Behaviors` for more information on how
...
:doc:`/The-Manual/Developing-with-CakePHP/Controllers`. CakePHP will automatically make
...
:doc:`/The-Manual/Developing-with-CakePHP/Models`. For details about join options, see
...
For more information on validation, see the :doc:`/The-Manual/Common-Tasks-With-CakePHP/Data-Validation` later on in this manual.
