...
available at http://www.example.com/cake\_1\_3/. We assume for the
...
(e.g. cake\_1.3.0). Rename this folder to cake\_1\_3. Your development
...
Cake application accessible at http://www.example.com/cake\_1\_3/.
...
-  /app/webroot/test.php (if you use the `Testing <view/1196/Testing>`_
   feature.)
...
#. Make sure your copy of CakePHP is from the downloads section of the
   ...
   Cake webroot directory (will be copied to your application's web root
   by bake):
...
Not working? If you're getting timezone related error from PHP uncomment
one line in app/config/core.php.
