...
Containable <https://book.cakephp.org/1.3/en/The-Manual/Core-Behaviors/Containable.html>`_ for
further details.
...
the behavior as seen in :doc:`/The-Manual/Developing-with-CakePHP/Behaviors`
