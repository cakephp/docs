...
The CakePHP Core includes a :doc:`Schema Cache Shell <console-commands/schema-cache>`
that you can use to perform this operation::

    $ bin/cake schema_cache clear

Be sure to read the :doc:`Schema Cache Shell <console-commands/schema-cache>`
